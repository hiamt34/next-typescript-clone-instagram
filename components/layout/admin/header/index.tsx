            ...
            <nav className="navbar navbar-expand-lg d-flex justify-content-between">
                ...
                <div className="header-search">
                    <form>
                        ...
                        <a href="#" className="close-search"><i data-feather="x" /></a>
                    </form>
                </div>
                <div className="flex-fill" id="headerNav">
                    <ul className="navbar-nav">
                        <li className="nav-item d-md-block d-lg-none">
                            <a className="nav-link" href="#" id="toggle-search"><i data-feather="search" /></a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link activity-trigger" href="#" id="activity-sidebar-toggle"><i data-feather="grid" /></a>
                        </li>
                        <li className="nav-item dropdown">
                            <a className="nav-link notifications-dropdown" href="#" id="notificationsDropDown" role="button" data-bs-toggle="dropdown" aria-expanded="false">3<div className="spinner-grow text-danger" role="status">
                            </div></a>
